...
export const processingService = {
  queue: (orgId: string, trackId: string, input_r2_key: string) =>
    supabase
      .from("processing_jobs")
      .insert({ organization_id: orgId, track_id: trackId, job_type: "audio_processing", status: "queued", input_r2_key })
      .select("*")
      .single(),
